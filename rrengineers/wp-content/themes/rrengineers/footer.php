                ...
                <div class="row g-5">
                    <div class="col-sm-6">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right me-2"></i>Evaporative Cooling</a>
                            <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right me-2"></i>Pal Ducting Material</a>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-white-50 mb-2" href="#"><i class="fa fa-angle-right me-2"></i>Fabrication Tools</a>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="w-100">
                            <div class="input-group">
                                <input type="text" class="form-control border-light" style="padding: 20px 30px;" placeholder="Your Email Address">
    ...
    <div class="container-fluid bg-dark bg-light-radial text-white border-top border-primary px-0">
        <div class="d-flex flex-column flex-md-row justify-content-between">
            <div class="py-4 px-5 text-center text-md-start">
                <p class="mb-0">&copy; <a class="text-primary" href="#">RR Engineers & Contractors</a>. All Rights Reserved.</p>
            </div>
